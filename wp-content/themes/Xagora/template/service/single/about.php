...
<section id="about" class="section-2 highlights image-right">
    <div class="container">
        <div class="row">
            <?php if (get_field('ssa_title', $id) && get_field('ssa_description', $id) && have_rows('ssa_features', $id)) : ?>
                <div class="col-12 col-md-6 pr-md-5 align-self-center text-center text-md-left text">
                    <div data-aos="fade-up" class="row intro">
                        <div class="col-12 p-0">
                            <span class="pre-title m-auto m-md-0"><?php echo sanitize_text_field(get_field('ssa_subtitle', $id)) ?></span>
                            <h2><?php echo replaceWithSpanTags(get_field('ssa_title', $id)) ?></h2>
                            <p><?php echo sanitize_textarea_field(get_field('ssa_description')) ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 pr-md-5 align-self-center text-center text-md-left text">
                    <?php
                    $i = 0;
                    while (have_rows('ssa_features', $id)) {
                        the_row();
